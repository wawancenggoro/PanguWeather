...
def training_loop(params, device, slurm_localid):
    ...
    for epoch in range(start_epoch, start_epoch + num_epochs):
        ...
        with torch.no_grad():
            ...
            val_loss, mse, acc, total_samples, dt_validation = eval.get_loss_synthetic(model, valid_data_loader, device, loss1, loss2, lat_crop=params['lat_crop'], lon_crop=params['lon_crop'], world_size=world_size)
